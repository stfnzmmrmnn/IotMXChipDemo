...
void loop()
{
  if (hasWifi)
  {
        ...
        (int)(SystemTickCounterRead() - send_interval_ms) >= getInterval())
    {
      ...
      bool *alerts = readMessage(messageCount, messagePayload, &temperature, &humidity);
      EVENT_INSTANCE* message = DevKitMQTTClient_Event_Generate(messagePayload, MESSAGE);
      DevKitMQTTClient_Event_AddProp(message, "temperatureAlert", alerts[0] ? "true" : "false");
      DevKitMQTTClient_Event_AddProp(message, "motionAlert", alerts[1] ? "true" : "false");
